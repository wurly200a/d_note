...
static const ACCEL accelTbl[] =
{
    ...
    { (FVIRTKEY|FNOINVERT)         ,VK_F3     ,IDM_EDIT_FIND_NEXT    },
    { (FVIRTKEY|FNOINVERT)         ,VK_F5     ,IDM_EDIT_DATETIME     },
    { (FVIRTKEY|FNOINVERT|FCONTROL),VK_HOME   ,IDM_EDIT_GOTO_FILE_TOP},
    { (FVIRTKEY|FNOINVERT|FCONTROL),VK_END    ,IDM_EDIT_GOTO_FILE_END},
};
...
MenuCreate( void )
{
    ...
    AppendMenu( hMenuPopup, MF_STRING   , IDM_EDIT_REDO       , TEXT("やり直し(&R)\tCtrl+Y") );
    AppendMenu( hMenuPopup, MF_SEPARATOR, 0                   , NULL );
